 ...
 * single digit. Suppose the digits are stored in forward order. Write a
...
public class LinkedListAdderForward {
    ...
    /**
     * Given two linked lists (that represent numbers in forward order i.e. the
     * 1s in the tail node), this method adds the numbers represented by the
    ...
    static LinkedListNode addLinkedLists(LinkedListNode a, LinkedListNode b) {
        ...
        if (a == null) {
            ...
            /**
             * to make it easier, we iterate and revert the linked list and
             * repeat the process as we did in the LinkedListAdderBackward
             */

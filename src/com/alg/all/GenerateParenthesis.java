...
public class GenerateParenthesis {
    ...
    public static void generateMatch(ArrayList<String> result, String s, int left, int right) {
        ...
        System.out.println("left is:"+left+" right is:"+right+" s is:"+s);
        if (left == 0 && right == 0) {
            result.add(s);
            return;
        }
        ...
        /**
         * if we have at least one left parenthesis, then we should use it
         * because every valid combination should start with a left parenthesis
         */

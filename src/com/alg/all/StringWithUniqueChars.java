...
* 
* Solution 1:
* Keep track of the count of the characters. If a duplicate entry is found, return false immediately.
* Also we can check if the length of the given string is greater than 256 as we have only 256 unique characters.
* 
* 
* Complexity: O(n)
 *

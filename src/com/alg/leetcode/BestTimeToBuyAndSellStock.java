...
public class BestTimeToBuyAndSellStock {
     ...
     * subarray A[low : mid], so that low &le; i &le; j &le; mid, ii) entirely
     * in the subarray A[mid + 1 : high], so that mid &lt; i &le; j &le; high,
     * or iii) crossing the midpoint, so that low &le; i &le; mid &lt; j &le
     * high.
     *
     * @param prices
     * @return

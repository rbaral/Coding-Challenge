...
public class WordRotationSubString{
	...
	/**
	checks whether the word2 is a rotational substring of word1 or not
	* we just concatenate the word1 with itself and check if word2 is a substring of it
	*For ex: waterbottle+waterbottle = waterbottlewaterbottle
	* contains the substring erbottlewat
	*/

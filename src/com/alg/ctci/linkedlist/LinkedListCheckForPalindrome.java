 ...
 * 
 * Solution 1: Create a linked list that is reverse of the given list and check if every node has a match.
 * 
 * Solution 2: We store the first half of the linked list into a stack and compare it with the second half by iterating through them
 * 
 * @author rbaral
 */
public class LinkedListCheckForPalindrome {
    ...
    public static void main (String args[]){
		...
		int [] nums = {2,3,3,2,1}; //1 is already added to the linkedlist

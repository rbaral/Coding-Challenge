...
public class Stack {
	...
	*/
	...
	/**
	this method is used when rolling over the set of stacks.
	this will remove the element at the bottom of the stack
	and other elements will shift to the left of the stack
	*/

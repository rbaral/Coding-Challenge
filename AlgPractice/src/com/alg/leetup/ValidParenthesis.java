...
public class ValidParenthesis {
	...
	/**
	 * we first check for simple base cases
	 * for other cases, we push each character to a list
	 * and check if the next character to be pushed forms a pair with
	 * the last pushed char. If found, we remove the last pushed char, else, we keep on pushing.
	 * If at the end, the list is empty, it means we have found pair for all the chars and we return true
